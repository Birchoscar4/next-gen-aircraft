def compute_wing_mass(spar_cap_radius, num_stringers, skin_thickness, spar_thickness):
    ...
    """    plt.figure(figsize=(12, 5))
        ...
        plt.show()"""
    print(buckled)
    return [x_cg,y_cg,z_cg,I_x,I_y,I_z,mass,buckled]

#compute_wing_mass(0.02,8,0.001,0.01)