def compute_vstab_mass(spar_cap_radius, num_stringers, skin_thickness, spar_thickness, max_q_velocity, max_q_density, load_factors, LE_spar, TE_spar):
    import numpy as np
    import re
    import pandas as pd
    ...
    for load_case in range(2):
        ...
        print("VStab Mass:", mass,"kg")
        print("VStab Tip deflection (m):", Ve[elements-1])

    return [x_cg,z_cg,y_cg,I_x,I_z,I_y,mass,buckled]

#compute_vstab_mass(0.08, 8, 0.01, 0.02, 210, 0.38, [3.5,-1], 0.1, 0.7)