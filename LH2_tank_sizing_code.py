...
class VacuumTankWeight(om.Group):
    ...
    def setup(self):
        ...
        self.set_input_defaults("radius", 1.0, units="m") #by default 1m, 1m also used for the BWB project analysis for cylindrical tank analysis scenario 1.
        self.set_input_defaults("length", 10, units="m") # by default 0.5m, this is the length of purely the cylindrical part of the tank. 
...
class PressureVesselWallThickness(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("radius", val=1, units="m") # by default 0.5m, 1m used for this initial cylindrical tank analysis. 
        self.add_input("length", val=10, units="m") #by default 2m, 10m used for this initial cylindrical tank analysis.
...
class VacuumWallThickness(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("radius", val=1, units="m") # by default 0.5m, 1m used for the analysis.
        self.add_input("length", val=10.0, units="m") # by default 2m, 10m used for the analysis. 
...
if __name__ == "__main__":
    ...
    p.set_val("vacuum_gap", 4, units="inch") # default 4 inches. Needs to be at least 2 to maintain the accuracy of the results. 
    p.set_val("radius", 4.26452, units="ft") # default 8.5 / 2. 1m is 3.28084ft
    p.set_val("length", 14.210785, units="ft") #default 0. 5m is 16.4042ft. 
