...
@Date    :   2023/03/25
@Author  :   Eytan Adler
@Description : Boeing 737-800 estimate using empirical weight and drag buildups - edited to consider a hydrogen based N3 engine cycle with drag and geometry characteristics of a BWB.
"""

# This gives the specific fuel burn based on the values given by the aerodynamics team.
...
import pandas as pd #this is required to export the thrust and mach number data to an excel file
...
plot_results(p, filename="specific_BWB_sizing_loop_results.pdf")
