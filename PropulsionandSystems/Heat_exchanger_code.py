...
class OSFGeometryTestCase(unittest.TestCase):
    ...
    def test_kayslondon_10_61(self): #changing these test cases changes the heat transfer coefficient, NTU and effectiveness of the heat exchanger.
        prob = Problem(OSFGeometryTestGroup(num_nodes=1))
        prob.setup(check=True, force_alloc_complex=True)
        prob.set_val("fin_thickness", 0.004, units="inch") #default is 0.004 inches
        prob.set_val("plate_thickness", 0.004, units="inch") #default is 0.004 inches
        prob.set_val("fin_length_cold", 1.0 / 10.0, units="inch") #default is 1/10
        fin_spacing = 1 / 19.35 - 0.004  # fin pitch minus fin thickness - default is 1 / 19.35-0.004
        prob.set_val("channel_height_cold", 0.0750 - 0.004, units="inch") #default is 0.0750 - 0.004
        prob.set_val("channel_width_cold", fin_spacing, units="inch") #default is fin spacing
        prob.set_val("n_long_cold", 2) #default is 2
        prob.set_val("mdot_cold", 0.0905, units="kg/s") #default is 0.0905
    ...
    def test_kayslondon_10_55(self):
        prob = Problem(OSFGeometryTestGroup(num_nodes=1))
        prob.setup(check=True, force_alloc_complex=True)
        prob.set_val("fin_thickness", 0.004, units="inch") #default is 0.004
        prob.set_val("plate_thickness", 0.004, units="inch") #default is 0.004
        prob.set_val("fin_length_cold", 1.0 / 8.0, units="inch") #default is 1/8
        fin_spacing = 1 / 15.61 - 0.004  # fin pitch minus fin thickness - default is 1 / 15.61-0.004
        prob.set_val("channel_height_cold", 0.250 - 0.004, units="inch") #default is 0.250 - 0.004
        prob.set_val("channel_width_cold", fin_spacing, units="inch") #default is fin spacing 
        prob.set_val("n_long_cold", 2) #default is 2
        prob.set_val("mdot_cold", 0.235, units="kg/s") #default is 0.235
    ...
    def test_kayslondon_10_60(self):
        ...
        prob.set_val("plate_thickness", 0.004, units="inch") #default is 0.004
        prob.set_val("fin_length_cold", 1.0 / 10.0, units="inch") #default is 1/10
        fin_spacing = 1 / 27.03 - 0.004  # fin pitch minus fin thickness - default is 1 / 27.03 - 0.004
        prob.set_val("channel_height_cold", 0.250 - 0.004, units="inch") #default is 0.250 - 0.004
        prob.set_val("channel_width_cold", fin_spacing, units="inch") #default is fin spacing
        prob.set_val("n_long_cold", 2) #default is 2
        prob.set_val("mdot_cold", 0.27, units="kg/s") #default is 0.27
    ...
    def test_kayslondon_10_63(self):
        ...
        prob.set_val("fin_thickness", 0.004, units="inch") #default is 0.004
        prob.set_val("plate_thickness", 0.004, units="inch") #default is 0.004
        prob.set_val("fin_length_cold", 3.0 / 32.0, units="inch") #default is 3/32
        fin_spacing = 0.082 - 0.004  # fin pitch minus fin thickness - default is 0.082 - 0.004
        prob.set_val("channel_height_cold", 0.485 - 0.004, units="inch") #default is 0.485 - 0.004
        prob.set_val("channel_width_cold", fin_spacing, units="inch") #default is fin spacing
        prob.set_val("n_long_cold", 4) #default is 4
        prob.set_val("mdot_cold", 0.54, units="kg/s") #default is 0.54
