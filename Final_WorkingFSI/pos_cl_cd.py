def pos_cl_cd():    
    ...
    vsp.SetIntAnalysisInput(analysis_name, "AlphaNpts", (21,), 0)
    vsp.SetDoubleAnalysisInput(analysis_name, "AlphaStart", (-10,), 0)
    ...
    if Mach < 0.8:
        ...
        plt.grid(True)
        plt.show() 
        df.to_csv('C:/Users/joepe/Documents/ProjectAero/updated_geom_pos_DegenGeom.csv', index=False)
    else:
        df = pd.read_csv('C:/Users/joepe/Documents/ProjectAero/OpenVSP-3.41.1-win64-Python3.11/OpenVSP-3.41.1-win64/python/update_geom_pos_DegenGeom.polar', delim_whitespace=True)
