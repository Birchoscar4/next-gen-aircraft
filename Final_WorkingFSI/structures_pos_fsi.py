...
def update_geom_pos(wing_id, start_index = 2, end_index = 10):
    ...
    try:
        with open(r"C:\Users\joepe\Documents\ProjectAero\OpenVSP-3.41.1-win64-Python3.11\OpenVSP-3.41.1-win64\python\def_twist_pos.csv", mode="r") as file:  # Replace with your .csv file
