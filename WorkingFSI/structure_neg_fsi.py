...
def update_geom_neg(wing_id, start_index = 2, end_index = 10):
    ...
    try:
        with open(r"E:\Engineering\Aerospace Engineering 2021-2025\Aerospace 2021-2025\\4th Year\MECH 5080 Team Project\CODES\Coupling Codes\Structures2cases\def_twist_neg.csv", mode="r") as file:  # Replace with your .csv file
