...
def update_geom_pos(wing_id, start_index = 2, end_index = 10):
    ...
    # UPLOAD THE DIRECTORY OF THE POSITIVE LOAD .CSV
    try:
        with open(r"E:\Engineering\Aerospace Engineering 2021-2025\Aerospace 2021-2025\\4th Year\MECH 5080 Team Project\CODES\Coupling Codes\Structures2cases\def_twist_pos.csv", mode="r") as file:  # Replace with your .csv file
    ...
    for xsec_index in range(start_index, min(end_index + 1, len(delta_y_values))):  # xsec_index is an integer
...
#update_geom_pos(wing_id = vsp.FindGeomsWithName("WING"))
